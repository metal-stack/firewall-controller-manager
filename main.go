...
func main() {
	...
	flag.DurationVar(&firewallHealthTimeout, "firewall-health-timeout", 30*time.Minute, "duration after a created firewall not getting ready is considered dead")
	flag.DurationVar(&createTimeout, "create-timeout", 30*time.Minute, "duration after which a firewall in the creation phase will be recreated")
